...
Database configuration information in *metabase.conf* in the Moodle installation directory, [refer to the installation directory](/stack-components.md#metabase)
